...
extern DashboardPages_t current_page; // Global variable to track the current dashboard page being displayed (e.g.,
                                      // help, auto, playlist, etc.)
...
// Handles the visual blinking effect of the selected menu item and manages state transitions for "Auto" and "Playlist"
// modes.
