 ...
 * Provides a high-level API for controlling ANSI-compatible terminals
 * (e.g., PuTTY, Tera Term). Core features include:
 ...
 * All coordinates (col, row) are 1-based to maintain consistency with ANSI/VT100 standards.
 ******************************************************************************
 */
